            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card mb-4 mb-xl-0">
                            <div class="card-body text-center">
                                <?php
                                $profilePicPath = site_url('assets/users/' . $user['profile_pic']);
                                ?>
                    ...
                    <div class="col-xl-8">
                        <div class="p-5">
                            <div class="user-info">
                                <p><strong>Complete Name:</strong> <?php echo $user['complete_name']; ?></p>
                                <p><strong>Username:</strong> <?php echo $user['email']; ?></p>
