                        ...
                        <div class="p-5">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" name="author_name" placeholder="Complete Name">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" name="title" placeholder="E.g Mr, Mrs, Dr">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="contact_num" placeholder="Contact Number">
                            </div>
